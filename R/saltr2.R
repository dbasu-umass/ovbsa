...
saltr2 <- function(
  ...
  .Deprecated("baci", msg = "'saltr2' is deprecated. Please use 'baci()' instead.")
  ...
  d2 <- expand.grid(X1 = skd, X2 = sky) %>%
    dplyr::mutate(
      ...
      Z1 = ovbsa::tr2bias(
        kd=X1, ky=X2, data = data, outcome = outcome,
  ...
  # ----- Proportion of area of the contour plot
  # ----- where confidence interval contains zero
  ...
  # ----- Probability of conclusion of study being overturned: Weighted
  # ----- Proportion of area of the contour plot
  # ----- where confidence interval contains zero
  # est1>0: fraction of area where confidence interval to the right of zero
